...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch(contactForm.action || 'https://formspree.io/f/mojpoaej', {
                    method: 'POST',
                    body: formData,
                    headers: {
                ...
                if (response.ok) {
                    showToast('Mensaje enviado, gracias por contactarme. Pronto recibirás una respuesta.');
                    contactForm.reset();
                } else {
                    ...
                    if (data.errors) {
                        ...
                        showToast('Hubo un problema al enviar el mensaje. Por favor, intenta de nuevo.', true);
                    }
                }
            } catch (error) {
                showToast('Hubo un problema al enviar el mensaje. Revisá tu conexión e intentá de nuevo.', true);
            }
        });
    }
